...
for (let index = 0; index < jobData.hits[0].benefits.length; index++) {
    console.log("-" +jobData.hits[0].benefits[index].benefitValue); 
}
console.log("--------------------------------------------------");
...
for (let i = 0; i < jobData.hits.length; i++) {
    ...
    console.log(" benefit : ");
    for (let index = 0; index < jobData.hits[i].benefits.length; index++) {
        console.log("-" +jobData.hits[i].benefits[index].benefitValue); 
    }  
    console.log("-----------");
}
console.log("--------------------------------------------------");
